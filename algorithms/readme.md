...
## Prerequisite
Before starting with Algorithms, let take a look on `recuresive function`, because sometime we will use it to implement some Algorithms.
